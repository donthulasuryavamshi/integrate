...
import com.virtusa.validation.UpdateMentorDetailsModelValidator;
...
public class MentorView  {
	...
	public static void lpMenu(UserModel userModel) {
		...
		try {
			...
			case 2:MentorController mentorController=new MentorController();
			mentorController.viewTraningCalendar();
				break;
	...
	public static void mentorProfile(String userId) {
		...
		try {
			...
			case 1:
				...
				mentorController.retrieveMentorDetails(userId);

				break;

			case 2:
				updateMentorDetails(userId);
	...
	public void viewMentorDetails(List<MentorModel> mentorModel) {
		for(MentorModel model:mentorModel) {
		System.out.println("Mentor ID:" + model.getId());
	...
	public static void updateMentorDetails(String userId) throws ClassNotFoundException, SQLException {

		UpdateMentorDetailsModelValidator validator = new UpdateMentorDetailsModelValidator();
		...
		UpdateMentorDetailsModel updateMentorDetailsView = new UpdateMentorDetailsModel();
		updateMentorDetailsView.setFirstName(firstName);
		updateMentorDetailsView.setLastName(lastName);
		updateMentorDetailsView.setEmail(email);
		updateMentorDetailsView.setPhoneNumber(phoneNumber);
		updateMentorDetailsView.setRole(role);
		updateMentorDetailsView.setCity(city);
		updateMentorDetailsView.setState(state);
		updateMentorDetailsView.setCountry(country);
		
		MentorController mentorController = new MentorController();
		mentorController.storeMentor(updateMentorDetailsView);}

	public void mentorProfileMenu(String userId) {
	...
	public void storeSuccess(String userId) {
		...
		mentorView.mentorProfileMenu(userId);
