...
public class LpDAOImpl implements LpDAO {
	...
	public  List<Lp> lpProfileView(String userId) throws ClassNotFoundException, SQLException {
		...
		PreparedStatement statement = connection.prepareStatement("select lp_id,first_name,last_name,phone_number,email,designation,city,state,country,batch_id from lp_details where lp_id=?");
